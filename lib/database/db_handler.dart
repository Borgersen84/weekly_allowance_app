    ...
    return openDatabase(
      ...
      onCreate: (database, version) async {
        await database.execute(
          "CREATE TABLE tasks(id INTEGER PRIMARY KEY AUTOINCREMENT, task_title TEXT NOT NULL, task_submitted TEXT NOT NULL, task_value INTEGER, week_number INTEGER, year_number INTEGER)",
        );
      },
      version: 1,
    );
